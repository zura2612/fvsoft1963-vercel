          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href={targetUrl}
                  className="group relative flex flex-col justify-between h-full p-6 sm:p-8 rounded-2xl bg-white/85 dark:bg-gray-900/85 backdrop-blur-sm border-2 border-black dark:border-white hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300"
                >
                  <div>
